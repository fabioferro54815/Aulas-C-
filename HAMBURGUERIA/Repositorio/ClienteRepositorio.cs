...
namespace Hamburgueria.Repositories {
    public class ClienteRepositorio : BaseRepository {
        ...
        private Cliente ConverterEmObjeto (string registro) {
            ...
            cliente.DataDeNascimento = DateTime.Parse(ExtrairCampo("data_nascimento", registro));

            return cliente;
        }

        private string PrepararRegistroCSV (Cliente cliente) {
            return $"id={CONT};nome={cliente.Nome};email={cliente.Email};senha={cliente.Senha};endereco={cliente.Endereco};telefone={cliente.Telefone};data_nascimento={cliente.DataDeNascimento}\n";
        }
